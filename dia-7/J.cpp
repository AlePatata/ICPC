...
/* Suma del iesimo caracter
El merge deberia cambiar dado un rango los 1's por 0's cuando en esa posicion hay un a
la consulta lr da la suma mayor o igual que 1, encontramos lo q estamos buscando(?) */
